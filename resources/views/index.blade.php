          ...
          @endif
                <div class="card-body">
                    ...
                    <form action=" " method="POST">
                        ...
                        <div class="mb-6">
                            <label for="project_name">selectProject <span class="required" style="color: red;">*</span></label>
                            <br>
                            <select name="project_name" class="form-select form-select-sm " aria-label=".form-select-sm example">
                             ...
                             @foreach ($project as $pro)
                               <option value="{{$pro->id}}">{{$pro->project_name}}
                                    </option>
                                @endforeach
                            </select>
                          </div>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="priority" class="form-control" name="priority" id="priority">
                        </div>
            ...
            <div class="col">
                <div class="card-body mt-3">
                    ...
                    <tbody> @foreach ($task as $sud)
                      <tr>
                       
                      
                        <td>{{$sud->task_name}}</</td>
                        <td>{{$sud->priority}}</</td>
                        <button><a href=" {{ url('/task/edit',$sud->id) }} ">
                            edit
                           </a></button>
                        
                          <button><a href=" {{ url('/task/delete',$sud->id) }} ">
                            delete
                           </a></button>
